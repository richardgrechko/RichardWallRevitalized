	...
	function(e) {
		...
		k["addEventListener"]("pointerdown", (function(e) {
			...
			if (e["isTrusted"]) {
				...
				}))) : ir("Please type your password.", 3e3) : ir("You have typed in your current username.", 3e3) : ir("Type a display name.", 3e3) : ir("Invalid display name!", 3e3)
			}
		...
		function vr(e) {
			...
			if (e = r["shift"](), r["length"] > 0 && (e += "/" + r["shift"]()), (e = (e = fr(e))["toLowerCase"]())["startsWith"]("~") && "~main" != e) {
				var a = e["split"]("/"),
					o = a[0]["replace"]("~", ""),
					i = "main";
				...
				var c = Lr(e);
				Zn(c.x, c.y), Cn("textwall", "main"), 0 == c.x && 0 == c.y ? $n() : history["pushState"]({}, null, e)
			}
			M["classList"]["remove"]("open")
		}
		...
		function mr(e) {
			var t = n;
			(tt["disablecolour"]["checked"] || nt["disableColour"]["checked"]) && (e = 0), pe != e && (Oe = !0);
			var r = document.getElementById(pe);
			r["classList"]["remove"]("selected"), pe = e, be = xe && 0 == pe ? "rgba(255, 255, 255, 0.6)" : Yr(se[pe], .6), (r = document["getElementById"](pe))["classList"]["add"]("selected"), r["offsetTop"] < w["scrollTop"] + 36 && (w["scrollTop"] = r["offsetTop"] - 36), r.offsetTop > w.scrollTop + w["clientHeight"] && (w.scrollTop = r.offsetTop - w.clientHeight), document.getElementById("theme-colour")["setAttribute"]("content", se[e]), localStorage["setItem"]("col", e), ge = !0
		}
		for (w["children"].length > 0 && (a = !0), ne = 0; ne < se["length"]; ne++) sr(fe[ne]);

		function hr(e) {
			for (var t = n, r = 0; r < w.children.length; r++) "0" != w["children"][r].id && (e ? w["children"][r]["classList"].add("hidden") : w["children"][r].classList.remove("hidden"));
			e && mr(0)
		}
		...
		function yr(e) {
			...
			0 == N && (xe = !1, document["getElementById"]("themeico")["src"] = "/static/sun.svg", C = S, A = I), 1 == N && (xe = !0, document["getElementById"]("themeico")["src"] = "/static/moon.svg", C = "#000000", A = "#141414"), 2 == N ? (xe = P.checked, document.getElementById("themeico")["src"] = "/static/star.svg", C = B["value"], A = F["value"], L["classList"].remove("hidden")) : L.classList["add"]("hidden"), T = Xr(A, 10), localStorage.setItem("theme", N), ge = !0, en(), mr(pe), Sn()
		}
